...
async def get_thumb(videoid):
    try:
        ...
        if 1 == 1:
            ...
            circle = Image.open("OmarMuSic/assets/Omar_stayl.png")
            ...
            # fonts
            font1 = ImageFont.truetype("OmarMuSic/assets/font2.ttf", 30)
            font2 = ImageFont.truetype("OmarMuSic/assets/font2.ttf", 70)
            font3 = ImageFont.truetype("OmarMuSic/assets/font2.ttf", 40)
            font4 = ImageFont.truetype("OmarMuSic/assets/font2.ttf", 35)

            image4 = ImageDraw.Draw(image2)
            image4.text(
                (10, 10), "Source AdRenalen ", fill="white", font=font1, align="left"
            )
            image4.text(
                (670, 150),
                "Source AdRenalen",
           ...
           DEV.SOURCE = f"• ⌯ Dev.Source : @DEV_ADRENALEN ⌯ •"
            ...
            image4.text(
                (670, 550), text=DEV.SOURCE, fill="white", font=font4, align="left"
            )
